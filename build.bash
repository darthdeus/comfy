...
case $1 in
    web-bin)
        ...
        RUSTFLAGS=--cfg=web_sys_unstable_apis cargo build --target wasm32-unknown-unknown $BUILD_FLAGS --example $@
        mkdir -p target/generated/
        rm -rf target/generated/*
        # cp -r examples/$1/resources target/generated/ || true
        sed "s/{{example}}/$1/g" > target/generated/index.html < index.html
        wasm-bindgen --out-dir target/generated --target web target/wasm32-unknown-unknown/release/examples/$1.wasm
    ;;
    serve)
        shift
